component{
	...
	function configure(){
		...
		coldbox = {
			...
			requestContextDecorator 	= "models.RequestContext",
		...
		interceptorSettings = {
			...
			customInterceptionPoints = "onIncomingMessage,invokeSendGatewayMessage,onStop"
		};
		...
		interceptors = [
			...
			//Gimpy
			{class="interceptors.GimpyInterceptor",
			 properties={}
			}
		];
